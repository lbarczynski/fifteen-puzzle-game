...
internal class StringBoardTest {
    ...
    fun `GIVEN board that can be moved up WHEN move up THEN should update board state`() {
        ...
        // then
        val expectedState: Board = StringBoard(
            board = arrayOf(
                intArrayOf(1, 2, 3),
                intArrayOf(0, 5, 6),
                intArrayOf(4, 7, 8)
    ...
    fun `GIVEN board WHEN get element THEN should return proper value`() {
        ...
        val board: Board = StringBoard(boardState)
    ...
    fun `GIVEN board WHEN copy THEN return deep board copy`() {
        ...
        // then
        val expectedResult: Board = StringBoard(
            board = arrayOf(
                intArrayOf(1, 2, 3),
                intArrayOf(4, 5, 6),
                intArrayOf(7, 8, 0)
